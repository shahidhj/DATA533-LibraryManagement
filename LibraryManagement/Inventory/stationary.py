...
class Pen(Transaction_Operation):
    ...
    def display_details(self):
        print("Pen Color:", self.color, "\nPen Type:", self.type, "\nPen Brand:", self.brand, "\nPen Price:", self.price)
...
class Pencil(Transaction_Operation):
    ...
    def display_details(self):
        print("Pencil Color", self.color, "\nPencil Type:", self.type, "\nPencil Thickness:", self.thickness, "\nPencil Brand:", self.brand, "\nPencil Price:", self.price)
...
class Notebook(Transaction_Operation):
    ...
    def display_details(self):
        print("Page Size", self.size, "\nNumber of Pages:", self.pages, "\nNotebook Brand:", self.brand, "\nNotebook Price:", self.price)       
